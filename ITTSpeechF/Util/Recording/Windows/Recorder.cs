...
namespace ITTSpeechF.Util.Recording.Windows
{
    public class Recorder : IDisposable
    {
        ...
        {
            FileName = "audio.wav";
            OutputFilePath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
        ...
        public void Iniciar()
        {
            ...
            WaveIn.DataAvailable += (s, a) =>
            {
                ...
                if (DateTime.Now < Start && timeMode) return;
                else if (DateTime.Now > End && timeMode) Detener();
